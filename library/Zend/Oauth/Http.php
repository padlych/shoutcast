...
{
    /**
     * Array of all My service parameters to be sent in the HTTP request
     ...
     * OAuth parameters, and a POST body for non-OAuth My parameters.
     *
     * @var string
     */
    ...
    /**
     * Mutator to set an array of My parameters for the HTTP request.
     *
    ...
    /**
     * Accessor for an array of My parameters.
     *
     * @return array
     */
     ...
     * @throws Zend_Oauth_Exception on HTTP request error
