...
/**
 * Helper to render error for a form element
 *
 * @category   Zend
 * @package    Zend_View
 * @subpackage Helper
...
class Zend_View_Helper_FormErrors extends Zend_View_Helper_FormElement
{
    ...
    /**
     * Set end string for displaying error
     *
     * @param  string $string
    ...
    /**
     * Retrieve end string for displaying error
     *
     * @return string
     */
    ...
    /**
     * Set separator string for displaying error
     *
     * @param  string $string
     * @return Zend_View_Helper_FormErrors
     */
    ...
    /**
     * Retrieve separator string for displaying error
     *
     * @return string
     */
    ...
    /**
     * Set start string for displaying error
     *
     * @param  string $string
     * @return Zend_View_Helper_FormErrors
     */
    ...
    /**
     * Retrieve start string for displaying error
     *
     * @return string
     */
