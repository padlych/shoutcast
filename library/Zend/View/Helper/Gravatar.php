...
class Zend_View_Helper_Gravatar extends Zend_View_Helper_HtmlElement
{
     ...
     * - 'img_size' int height of images to return
     * - 'default_img' string images to return if email adress has not found
    ...
    /**
     * Set images size in pixels
     *
     * @param int $imgSize Size of images must be between 1 and 512
     * @return Zend_View_Helper_Gravatar
     */
