...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
    ...
    /**
     * Flag indicating whether or not LFI protection for rendering view script is enabled
     * @var bool
     */
    ...
    /**
     * Allow My object initialization when extending Zend_View_Abstract or
     * Zend_View
     *
    ...
    public function addBasePath($path, $classPrefix = 'Zend_View')
    {
        ...
        $path       .= DIRECTORY_SEPARATOR;
        $classPrefix = rtrim($classPrefix, '_') . '_';
        $this->addScriptPath($path . 'script');
     ...
     * to enforce strict variable handling in your view script.
     *
     * @param  boolean $flag
     * @return Zend_View_Abstract
     */
    ...
    protected function _script($name)
    {
        if ($this->isLfiProtectionOn() && preg_match('#\.\.[\\\/]#', $name)) {
            require_once 'Zend/View/Exception.php';
            $e = new Zend_View_Exception('Requested script may not include parent directory traversal ("../", "..\\" notation)');
            $e->setView($this);
            throw $e;
        }
