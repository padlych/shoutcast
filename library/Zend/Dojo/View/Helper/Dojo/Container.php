...
class Zend_Dojo_View_Helper_Dojo_Container
{
    ...
    /**
     * Specify one or multiple models to require
     *
    ...
    /**
     * Retrieve list of models to require
     *
     * @return array
     */
    ...
    /**
     * Get all stylesheet models currently registered
     *
     * @return array
     */
...
EOJ;
    ...
    protected function _getLocalRelativePath()
    {
        if (null === $this->_localRelativePath) {
            ...
            $localPath = preg_replace('|[/\\\\]dojo[/\\\\]dojo.script[^/\\\\]*$|i', '', $localPath);
    ...
    /**
     * Render layers (My builds) as script tags
     *
     * @return string
     */
