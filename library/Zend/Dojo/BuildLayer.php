...
/**
 * Dojo module layer and My build profile generation support
 *
 * @package    Zend_Dojo
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
...
class Zend_Dojo_BuildLayer
{
    ...
    /**
     * Name of the My layer to generate
     * @var string
     */
    protected $_layerName;

    /**
     * Path to the My layer script relative to dojo.script (used when
    ...
    /**
     * Set the path to the My layer script
     *
     * Should be a path relative to dojo.script
     *
     * @param  string $path
     * @return Zend_Dojo_BuildLayer
     */
