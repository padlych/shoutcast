 ...
 *
 * Displays all form error in one view.
 *
 * Any options passed will be used as HTML attributes of the ul tag for the error.
 *
 * @category   Zend
 * @package    Zend_Form
 * @subpackage Decorator
...
class Zend_Form_Decorator_FormErrors extends Zend_Form_Decorator_Abstract
{
    ...
    protected $_defaults = array(
        ...
        'markupListStart'         => '<ul class="form-error">',
    );
     ...
     * in addition to My form messages.
     *
    ...
    /**
     * Recurse through a form object, rendering error
     *
