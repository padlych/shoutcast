 ...
 * application error, and forward to an error handler.
 *
...
class Zend_Controller_Plugin_ErrorHandler extends Zend_Controller_Plugin_Abstract
{
    ...
    /**
     * Module to use for error; defaults to default module in dispatcher
     * @var string
     */
    protected $_errorModule;

    /**
     * Controller to use for error; defaults to 'error'
     * @var string
     */
    protected $_errorController = 'error';

    /**
     * Action to use for error; defaults to 'error'
     * @var string
     */
