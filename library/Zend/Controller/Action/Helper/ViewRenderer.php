 ...
 * set:
 *
 * - noController: if set true, render() will not look for view script in
...
class Zend_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
     ...
     * - noController - flag indicating whether or not to look for view script in subdirectories named after the controller
