...
class Zend_Validate_File_Upload extends Zend_Validate_Abstract
{
     ...
     *
     * Returns true if and only if the file was uploaded without error
     *
     * @param  string $value Single file to check for upload error, when giving null the $_FILES array
