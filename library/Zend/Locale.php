...
class Zend_Locale
{
    ...
    public static function getDefault()
    {
        if ((self::$compatibilityMode === true) or (func_num_args() > 0)) {
            if (!self::$_breakChain) {
                ...
                trigger_error('You are running Zend_Locale in compatibility mode... please migrate your script', E_USER_NOTICE);
    ...
    /**
     * Returns an array with the name of all script translated to the given language
     *
