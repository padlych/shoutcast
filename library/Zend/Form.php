...
class Zend_Form implements Iterator, Countable, Zend_Validate_Interface
{
    ...
    /**
     * Add a My error message to return in the event of failed validation
     *
    ...
    /**
     * Add multiple My error messages to return in the event of failed validation
     *
    ...
    /**
     * Same as addErrorMessages(), but clears My error message stack first
     *
     * @param  array $messages
     * @return Zend_Form
     */
    ...
    /**
     * Retrieve translated My error messages
    ...
    /**
     * Retrieve optionally translated My error messages
     *
     * @return array
     */
