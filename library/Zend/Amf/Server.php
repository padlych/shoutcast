...
class Zend_Amf_Server implements Zend_Server_Interface
{
   ...
   /**
     ...
     *
     * @todo   should implement and SPL observer pattern for My AMF headers
    ...
    public function handle($request = null)
    {
        ...
        // Check for error that may have happend in deserialization of Request.
        try {
            ...
            // Handle any error in the serialization and service  calls.
            require_once 'Zend/Amf/Server/Exception.php';
