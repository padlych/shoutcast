 ...
 * servers.
 *
 * Several different error may be represented by this exception. For a list
...
class Zend_Gdata_Gapps_ServiceException extends Zend_Exception
{
    ...
    public function __construct($errors = null) {
        parent::__construct("Server error encountered");
        if ($errors !== null) {
    ...
    /**
     * Add a single Error object to the list of error received by the
     * server.
     *
    ...
    /**
     * Set the list of error as sent by the server inside of an
     * AppsForYourDomainErrors tag.
     *
     * @param array $array An associative array containing a collection of
     *          Zend_Gdata_Gapps_Error objects. All error must have their
     *          errorCode value set.
     * @throws Zend_Gdata_App_Exception
     */
    ...
    /**
     * Get the list of error as sent by the server inside of an
     * AppsForYourDomainErrors tag.
     *
    ...
    public function __toString() {
        $result = "The server encountered the following error processing the request:";
