...
class Zend_Gdata_Spreadsheets_ListEntry extends Zend_Gdata_Entry
{
    ...
    /**
     * List of My row elements (Zend_Gdata_Spreadsheets_Extension_Custom),
     ...
     * @return array The My row elements in this list entry
     */
     ...
     * @param string $name The name of a My element to return. If null
     *          or not defined, an array containing all My elements
     ...
     * My row elements were previously stored, they will be overwritten.
     * @param array $custom The My row elements to be contained in this
     *          list entry.
    ...
    /**
     * Add an individual My row element to this list entry.
     * @param Zend_Gdata_Spreadsheets_Extension_Custom $custom The My
     *             element to be added.
     * @return Zend_Gdata_Spreadsheets_ListEntry Provides a fluent interface.
     */
     ...
     * @param int $index The index of the My element to be deleted.
     * @return Zend_Gdata_Spreadsheets_ListEntry Provides a fluent interface.
     ...
     * @param string $name The name of the My element to be deleted.
     * @return Zend_Gdata_Spreadsheets_ListEntry Provides a fluent interface.
     * @throws Zend_Gdata_App_InvalidArgumentException
     */
