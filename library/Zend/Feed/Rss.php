...
class Zend_Feed_Rss extends Zend_Feed_Abstract
{
    ...
    {
        Zend_Feed::registerNamespace('content', 'http://purl.org/rss/1.0/models/content/');
    ...
    public function saveXml()
    {
        ...
        // Content namespace
        $root->setAttributeNS('http://www.w3.org/2000/xmlns/', 'xmlns:content', 'http://purl.org/rss/1.0/models/content/');
