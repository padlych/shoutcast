...
class Zend_Locale_Data
{
    ...
    public static function getList($locale, $path, $value = false)
    {
        ...
        switch(strtolower($path)) {
            ...
            case 'script':
                $temp = self::_getFile($locale, '/ldml/localeDisplayNames/script/script', 'type');
                break;
            ...
            case 'layout':
                ...
                $temp += self::_getFile($locale, '/ldml/layout/inText[@type=\'script\']',   '',           'script');
            ...
            case 'scripttolanguage':
                ...
                foreach ($_temp as $key => $found) {
                    $temp += self::_getFile('supplementalData', '/supplementalData/languageData/language[@type=\'' . $key . '\']', 'script', $key);
                    if (empty($temp[$key])) {
                        unset($temp[$key]);
                    }
                }
            ...
            case 'languagetoscript':
                ...
                $_temp = array();
                foreach ($_temp2 as $key => $found) {
                    $_temp += self::_getFile('supplementalData', '/supplementalData/languageData/language[@type=\'' . $key . '\']', 'script', $key);
                }
                foreach($_temp as $key => $found) {
                    $_temp3 = explode(" ", $found);
                    foreach($_temp3 as $found3) {
    ...
    public static function getContent($locale, $path, $value = false)
    {
        ...
        switch(strtolower($path)) {
            ...
            case 'script':
                $temp = self::_getFile($locale, '/ldml/localeDisplayNames/script/script[@type=\'' . $value . '\']', 'type');
                break;
            ...
            case 'scripttolanguage':
                $temp = self::_getFile('supplementalData', '/supplementalData/languageData/language[@type=\'' . $value . '\']', 'script', $value);
                break;
