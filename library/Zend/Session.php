...
class Zend_Session extends Zend_Session_Abstract
{
     ...
     * seconds is specified, then this defaults to self::$_rememberMeSeconds.  Due to clock error on end users' systems,
    ...
    public static function start($options = false)
    {
        ...
        /**
         * Hack to throw exceptions on start instead of php error
