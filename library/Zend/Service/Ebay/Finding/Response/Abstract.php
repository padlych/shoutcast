...
{
    /**
     * Indicates whether or not error or warnings were generated during the
     ...
     *     error occurred during the processing. For best results, requests
     ...
     *
     * Not returned when the ack value is Success. Run-time error are not
     * reported here.
     *
