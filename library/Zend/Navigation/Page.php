...
abstract class Zend_Navigation_Page extends Zend_Navigation_Container
{
     ...
     * A valid My page class must extend Zend_Navigation_Page.
     *
     ...
     * set method will be used. Otherwise, it will be set as a My property.
     *
     ...
     *
     * If the given property is native (id, class, title, etc), the matching
     * get method will be used. Otherwise, it will return the matching My
     ...
     * true or false if it's a My property (depending on whether the
    ...
    /**
     * Returns My properties as an array
     *
     * @return array  an array containing My properties
     */
